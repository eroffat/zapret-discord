...
1. Выключите антивирус (Параметры -> Обновление и Безопасность -> Безопасность Windows -> Защита от угроз и вирусов -> В середине синий текст Управление настройками -> Защита в реально времени выкл.)

2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/eroffat/zapret-discord/releases/latest)

3. Распакуйте содержимое архива на рабочий стол

4. Запустите general.bat
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/eroffat/zapret-discord/releases) (`zapret-discord-...`)
