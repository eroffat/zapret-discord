...
0. Выключите антивирус (Параметры -> Обновление и Безопасность -> Безопасность Windows -> Защита от угроз и вирусов -> В середине синий текст Управление настройками -> Защита в реально времени выкл.)
...
5. Запустите нужный файл (general.bat)
